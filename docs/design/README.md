...
| [cross-cutting-rules.md](cross-cutting-rules.md) | Prescriptive rules that apply across all providers (list defaults, cross-provider fields, tailored-tier shape parity, …) |
