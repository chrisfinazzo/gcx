...
func (p *AIO11yProvider) Commands() []*cobra.Command {
	...
	experimentsCmd.Annotations = map[string]string{
		agent.AnnotationTokenCost: "medium",
		agent.AnnotationLLMHint:   `gcx aio11y experiments list -o json; gcx aio11y experiments get <experiment-id> -o yaml; gcx aio11y experiments report <experiment-id> -o json; gcx aio11y experiments test-suites list -o json; gcx aio11y experiments test-suites cases list <suite-id> <version> -o json; gcx aio11y experiments trials list <experiment-id> -o json`,
	}
