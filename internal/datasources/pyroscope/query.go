...
func (opts *pyroscopeQueryOpts) setup(flags *pflag.FlagSet) {
	...
	flags.StringVar(&opts.ProfileType, "profile-type", "", "Profile type ID (e.g., 'process_cpu:cpu:nanoseconds:cpu:nanoseconds'); use 'gcx profiles list-types' to list available (required)")
