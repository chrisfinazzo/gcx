...
| [019](docs/adrs/oncall-feature-expansion/001-sre-expansion.md) | Expand `gcx irm oncall` for the SRE persona (alert payload, shifts shape parity, bulk-by-filter, agent-mode contract, hint conventions) | proposed |
